var RSA = function () {
    ...
    function w(t, e) {
        ...
        for (var i = t.length,
            ...
            p < 0 ? "-" == t.charAt(i) && (o = !0) : (o = !1, 0 == r ? this[this.t++] = p : r + n > this.DB ? (this[this.t - 1] |= (p & (1 << this.DB - r) - 1) << r, this[this.t++] = p >> this.DB - r) : this[this.t - 1] |= p << r, (r += n) >= this.DB && (r -= this.DB))
        }
    ...
    function _(t) {
        ...
        if (a-- > 0) for (p < this.DB && (n = this[a] >> p) > 0 && (o = !0, r = l(n)); a >= 0;) p < e ? (n = (this[a] & (1 << p) - 1) << e - p, n |= this[--a] >> (p += this.DB - e)) : (n = this[a] >> (p -= e) & i, p <= 0 && (p += this.DB, --a)),
        n > 0 && (o = !0),
        o && (r += l(n));
        return o ? r : "0"
    }
    ...
    function X() {
        if (null == ut) {
            for (W(), ut = it(), ut.init(lt), dt = 0; dt < lt.length; ++dt) lt[dt] = 0;
            dt = 0
        }
        return ut.next()
    }
    ...
    var at, pt, st = "0123456789abcdefghijklmnopqrstuvwxyz",
        ct = new Array;
    for (at = "0".charCodeAt(0), pt = 0; pt <= 9; ++pt) ct[at++] = pt;
    for (at = "a".charCodeAt(0), pt = 10; pt < 36; ++pt) ct[at++] = pt;
    for (at = "A".charCodeAt(0), pt = 10; pt < 36; ++pt) ct[at++] = pt;
    ...
    if (null == lt) {
        lt = new Array,
            dt = 0;
        var ft;
        for (; dt < gt;) ft = Math.floor(65536 * Math.random()),
            lt[dt++] = ft >>> 8,
            lt[dt++] = 255 & ft;
        dt = 0,
            W()
...
var pt = function (t) {
    ...
    function p(t) {
        var e, n, i = [],
            o = t.length;
        for (e = 0; e < o; e++) n = t.charCodeAt(e),
    ...
    function s(t) {
        ...
        0 != w && (w = 8 - w),
            b = new Array(n + w + 10),
            m[0] = 255 & (248 & e() | w);
        for (var o = 1; o <= w; o++) m[o] = 255 & e();
        w++;
        for (var o = 0; o < 8; o++) _[o] = 0;
        for (i = 1; i <= 2;) w < 8 && (m[w++] = 255 & e(), i++),
        8 == w && u();
        for (var o = 0; n > 0;) w < 8 && (m[w++] = t[o++], n--),
        8 == w && u();
        for (i = 1; i <= 7;) w < 8 && (m[w++] = 0, i++),
        8 == w && u();
        return b
    }
    ...
    function c(t) {
        var e = 0,
            n = new Array(8),
            i = t.length;
        if ($ = t, i % 8 != 0 || i < 16) return null;
        if (_ = d(t), w = 7 & _[0], (e = i - w - 10) < 0) return null;
        for (var o = 0; o < n.length; o++) n[o] = 0;
        b = new Array(e),
            y = 0,
            v = 8,
            w++;
        for (var r = 1; r <= 2;) if (w < 8 && (w++, r++), 8 == w && (n = t, !f())) return null;
        for (var o = 0; 0 != e;) if (w < 8 && (b[o] = 255 & (n[y + w] ^ _[w]), o++, e--, w++), 8 == w && (n = t, y = v - 8, !f())) return null;
        for (r = 1; r < 8; r++) {
            if (w < 8) {
    ...
    function u() {
        for (var t = 0; t < 8; t++) m[t] ^= k ? _[t] : b[y + t];
        for (var e = l(m), t = 0; t < 8; t++) b[v + t] = e[t] ^ _[t],
            _[t] = m[t];
        y = v,
            v += 8,
            w = 0,
    ...
    function l(t) {
        for (var e = 16,
                 o = n(t, 0, 4), r = n(t, 4, 4), a = n(g, 0, 4), p = n(g, 4, 4), s = n(g, 8, 4), c = n(g, 12, 4), u = 0; e-- > 0;) u += 2654435769,
            u = (4294967295 & u) >>> 0,
            o += (r << 4) + a ^ r + u ^ (r >>> 5) + p,
            o = (4294967295 & o) >>> 0,
            r += (o << 4) + s ^ o + u ^ (o >>> 5) + c,
    ...
    function d(t) {
        for (var e = 16,
                 o = n(t, 0, 4), r = n(t, 4, 4), a = n(g, 0, 4), p = n(g, 4, 4), s = n(g, 8, 4), c = n(g, 12, 4), u = 3816266640; e-- > 0;) r -= (o << 4) + s ^ o + u ^ (o >>> 5) + c,
            r = (4294967295 & r) >>> 0,
            o -= (r << 4) + a ^ r + u ^ (r >>> 5) + p,
            o = (4294967295 & o) >>> 0,
            u -= 2654435769,
    ...
    function f() {
        for (var t = ($.length, 0); t < 8; t++) _[t] ^= $[v + t];
        return _ = d(_),
            v += 8,
            w = 0,
            !0
    ...
    q.PADCHAR = "=",
        ...
        q.encode = function (t) {
            ...
            for (e = 0; e < p; e += 3) n = r(t, e) << 16 | r(t, e + 1) << 8 | r(t, e + 2),
 ...
 * 获取QQ加密后的字符串
 * e	QQ密码
 * n	QQ账号(进过16进制转换后的QQ字符编码)
 * i	验证码
 * o	默认(false)
 */
function getQQEncryption(e, n, i, o) {
    return Encryption.getEncryption(e, n, i, o);
}